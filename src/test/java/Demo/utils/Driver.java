...
import static Demo.frameworkConfiguration.FrameworkParameter.getRemoteTestEnvIpAddress;
import static io.github.bonigarcia.wdm.DriverManagerType.CHROME;
import static io.github.bonigarcia.wdm.DriverManagerType.FIREFOX;
import static main.DemoSolutionTestSuite.remoteTestEnvIPAddress;
...
public class Driver extends Thread {
    ...
    private static WebDriver _get() {
        ...
        switch (useThisDriver) {
            case FIREFOX:
                ...
                aDriver.manage().timeouts().pageLoadTimeout(60, TimeUnit.SECONDS);
                aDriver.manage().timeouts().setScriptTimeout(60, TimeUnit.SECONDS);
                break;
            ...
            case REMOTE:
                ...
                assert aDriver != null;
                aDriver.manage().timeouts().pageLoadTimeout(160, TimeUnit.SECONDS);
                aDriver.manage().timeouts().setScriptTimeout(160, TimeUnit.SECONDS);
                break;
        }
    ...
    private static WebDriver determineRemoteDriver() {
        ...
        try {
            LOGGER.info("Getting to http://" + remoteTestEnvIPAddress + ":4444/wd/hub");
            return new RemoteWebDriver(new URL("http://" + remoteTestEnvIPAddress + ":4444/wd/hub"), chromeOptions);
